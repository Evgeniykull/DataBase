...
void ModelLimit::finishAddLimits(QString fuelName, QString value, QString type, QString endDate) {
    ...
    QString statament = QString("INSERT INTO limits (userid, fuelid, valuel, typed, enddate, limgroup) VALUES (%1, %2, %3, %4, %5, '%6', %7)")
            .arg(userId)
            .arg(fuelName)
            .arg(value)
            .arg(type)
...
void ModelLimit::finishEditLimits(int limitsId, QString fuelName, QString value, QString type, QString endDate) {
    QSqlQuery* query = new QSqlQuery(data_base);
    QString statament = QString("UPDATE limits SET userid=%1, fuelid=%2, valuel=%3, typed=%4, enddate='%5'  WHERE id=%6")
            .arg(userId)
            .arg(fuelName)
            .arg(value)
            .arg(type)
